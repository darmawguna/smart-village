                ...
                <div className="flex flex-col w-[95%] max-w-7xl">
                    <div className="bg-color5 h-[40vh] flex justify-between items-center px-10 rounded-lg mb-8">
                        <div className="ssm:flex ssm:flex-col ssm:items-center ssm:justify-center">
                            ...
                            <ButtonNavigate navigateTo='#produk' variant="w-[200px] rounded-lg px-2 py-2 text-center bg-white flex justify-between mt-2 items-center hover:bg-gray-100 transition-colors duration-200">
                        ...
                        {filteredProduk.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-16">
                                ...
                                <p className="text-gray-500 text-center max-w-md mb-6">
                                    Maaf, tidak ada produk yang cocok dengan pencarian "{searchTerm}". 
